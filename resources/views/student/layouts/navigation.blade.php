<aside id="sidebar" class="sidebar-panel closed fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 lg:translate-x-0 lg:z-auto">
    ...
    <nav class="p-4 space-y-1 overflow-y-auto" style="height: calc(100vh - 8rem);">
        <a href="#" class="{{ request()->routeIs('student') ? 'sidebar-link active' : '' }} flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
        ...
        <a href="{{route('student.claims.show')}}" class="sidebar-link flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
